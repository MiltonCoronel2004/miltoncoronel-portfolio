      ...
      <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row'>
        <div className='flex flex-col justify-center h-full'>
          ...
          <p className='py-4 text-gray-500'>
            Mi nombre es Milton Coronel. Tengo 6 años de estudio en el área informática y 3 años de experiencia en el desarrollo de software. Actualmente, me encuentro desarrollando proyectos web propios con React, PHP, Node.js, Laravel, MySQL y MongoDB.
          </p>
